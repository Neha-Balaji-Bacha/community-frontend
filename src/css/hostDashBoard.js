const styles = {
  page:
    "min-h-screen bg-gradient-to-br from-white via-gray-50 to-emerald-100 py-12 px-4 ",

  container:
    "max-w-7xl mx-auto space-y-10",

  header:
    "flex flex-col md:flex-row md:justify-between md:items-center gap-6 pb-4 border-b border-gray-200",
